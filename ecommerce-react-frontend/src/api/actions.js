...
export async function getSearchedProducts(params, query) {
  try {
    const { data } = await ecommerceApi.get(`/api/products/search/${query}`, {
      params: params,
    });
    return data;
  } catch (error) {
...
export async function getSimmilarProducts(itemName, pageSize) {
  try {
    const { data } = await ecommerceApi.post(
      `/api/products/similar/${itemName}/${pageSize}`
    );
    return data;
  } catch (error) {
    console.log(error.message);
...
export async function getProductsByItemNameId(id) {
  try {
    const { data } = await ecommerceApi.get(
      `/api/products/section/itemName/${id}`
    );
    return data;
  } catch (error) {
    console.log(error.message);
